...
$product_name = $_GET['producto'] ?? 'AGUA ALL NATURAL S-GASX1LT';

// Mock data for specific product Kardex
$movimientos = [
    ['fecha' => '14/12/2025 16:40', 'tipo' => 'AJUSTE INGRESO', 'tipo_class' => 'bg-info', 'detalle' => 'Ajuste AJ-20251214-28/AB4: Inventario Físico', 'ingreso' => '+1,00', 'egreso' => '-', 'saldo' => '3,00'],
];
?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="content-wrapper">
                <div class="kardex-header">
                    <div class="kardex-title">
                        <h1><i class="fas fa-chart-line"></i> Kardex:
                    ...
                    <div style="display: flex; gap: 10px;">
                        <a href="kardex.php" class="btn btn-outline">
                            <i class="fas fa-arrow-left"></i> Volver al Kardex General
                        </a>
