...
<head>
    <meta charset="UTF-8">
    <title>Perfil del Cliente | Sistema POS</title>
            ...
            <div class="content-wrapper">
                <div class="u-header-btn"
                    ...
                    <div style="display:flex; gap: 10px;">
                        <a href="editar.php?id=<?php echo $id; ?>" class="btn btn-secondary"><i class="fas fa-edit"></i>
                            Editar</a>
                    </div>
                </div>
                    ...
                    <div class="info-card">
                        ...
                        <div style="border-top: 1px solid #f1f5f9; padding-top: 20px;">
                            <div style="margin-bottom: 12px;">
                                <label
                                    style="font-size: 0.75rem; color: #64748b; display: block;">Identificación</label>
                            ...
                            <div style="margin-bottom: 12px;">
                                ...
                                <strong
                                    style="font-size: 0.85rem; color: #475569;"><?php echo htmlspecialchars($cliente['direccion'] ?: 'No registrado'); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="stat-mini-grid">
                            <div class="stat-mini">
                                <span
                                    style="font-size: 0.7rem; color: #64748b; text-transform: uppercase;">Compras</span>
                                <div style="font-weight: 700; font-size: 1.2rem; color: #0061f2;">
                                    <?php echo $cantCompras; ?>
                                </div>
                            </div>
                            <div class="stat-mini">
                                <span style="font-size: 0.7rem; color: #64748b; text-transform: uppercase;">Total
                                    Comprado</span>
                                <div style="font-weight: 700; font-size: 1.2rem; color: #10b981;">
                                    $<?php echo number_format($totalComprado, 2); ?></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php if (empty($ventas)): ?>
                            <div style="text-align: center; padding: 40px; color: #94a3b8;">
                                <i class="fas fa-shopping-bag"
                                    style="font-size: 3rem; opacity: 0.2; margin-bottom: 15px;"></i>
                                    ...
                                    <tbody>
                                        <?php foreach ($ventas as $v): ?>
                                            <tr>
                                                ...
                                                <td style="font-weight: 600; color: #0061f2;"><?php echo $v['numeroFactura']; ?>
                                                </td>
                                                <td><?php echo htmlspecialchars($v['vendedor'] ?: 'Admin'); ?></td>
                                                <td><span
                                                        class="status-badge status-authorized"><?php echo $v['estado']; ?></span>
                                                </td>
                                                <td style="font-weight: 700;">$<?php echo number_format($v['total'], 2); ?></td>
                                                <td>
                                                    <a href="../ventas/ver_factura.php?id=<?php echo $v['id']; ?>"
                                                        class="btn-act view" title="Ver Factura"><i
